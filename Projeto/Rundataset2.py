...
metricas = []
metricas.append(accMetrics)
metricas.append(precisionMetrics)
metricas.append(recallMetrics)
metricas.append(f1Metrics)
metricas.append(timeMetrics)

Dados2 = pd.DataFrame(metricas)
nomeExcel = 'ReesultsoutroMetricas.xlsx'
excel = pd.ExcelWriter(nomeExcel, engine='xlsxwriter')        
Dados2.to_excel(excel, sheet_name='Planilha de Reesults')
excel.save() 